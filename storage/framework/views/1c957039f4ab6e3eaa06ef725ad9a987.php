    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <td>
              <a href="/showbobotkriteria/<?php echo e($post->id); ?>" class="btn btn-warning btn-sm">Edit</a>
              <a href="/deletebobotkriteria/<?php echo e($post->id); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Confirm To Delete')"">Delete</a>
            </td>
          </td>
        </tr>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\Semester 4\Sistem Informasi\Website SI\WEBSI\resources\views/dashboard/bobot_kriterias/index.blade.php ENDPATH**/ ?>